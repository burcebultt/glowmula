...
const quizQuestions: Question[] = [
  ...
  {
    id: 2,
    question: "Öğleden sonra aynaya baktığınızda cildinizde en çok neyi fark edersiniz?",
    subtitle: "Günün ortasındaki genel görünümünüzü değerlendirin.",
    options: [
      { label: "Gözeneklerim belirgindir ve gün içinde hızla parlarım.", type: "Yaglı" },
      { label: "Cildim mat durur, bazı bölgelerde pul pul bir görünüm olabilir.", type: "Kuru" },
      { label: "Sadece T bölgemde (alın, burun, çene) gözenek ve parlama fark ederim.", type: "Karma" },
      { label: "Hafif bir kızarıklık veya gerginlik hissi oluşur.", type: "Hassas" },
    ],
  },
  {
    id: 3,
    question: "Yeni bir cilt bakım ürünü denediğinizde cildinizin tepkisi genellikle nasıl olur?",
    subtitle: "Ürün değişimlerine verdiğiniz genel tepkiyi düşünün.",
    options: [
  ...
  {
    id: 4,
    question: "Hava aniden soğuduğunda ya da uzun süre klimalı bir ortamda kaldığınızda cildiniz nasıl tepki verir?",
    subtitle: "Mevsim veya ortam değişikliklerindeki tepkinizi düşünün.",
    options: [
      { label: "Cildim ciddi şekilde gerilir, çekilir ve acil nem ister.", type: "Kuru" },
      { label: "Yanaklarım kurur ve gerilirken T bölgem pek etkilenmez.", type: "Karma" },
      { label: "Kolayca kızarır, tahriş olur veya hassaslaşır.", type: "Hassas" },
      { label: "Fazla etkilenmem, dengemi büyük ölçüde korurum.", type: "Normal" },
    ],
  },
  {
    id: 5,
    question: "Gün sonunda güneş kreminiz veya makyajınız cildinizde genellikle nasıl durur?",
    subtitle: "Günün sonundaki cilt görünümünüzü ve hissinizi düşünün.",
    options: [
      { label: "Erir, kayar ve parlama belirginleşir.", type: "Yaglı" },
      { label: "Cilt üzerinde matlaşır, bazı bölgelerde çatlamış gibi durabilir.", type: "Kuru" },
      { label: "Kızarıklık, iritasyon veya hafif dökülme oluşabilir.", type: "Hassas" },
      { label: "Gün boyunca oldukça düzgün ve stabil kalır.", type: "Normal" },
    ],
  },
];
